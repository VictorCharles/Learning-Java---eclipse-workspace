...
public class MultiplicaEntreVetor {
	public static void main(String[] args) {
		...
		for (int n = 0; n < 10; n++) {
			vetor1[n] = Integer
					.parseInt(JOptionPane.showInputDialog(null, "Digite um valor a ser armazenado", "Vetor 1", 3));
		}
		for (int n = 0; n < 10; n++) {
			vetor1[n] = Integer
					.parseInt(JOptionPane.showInputDialog(null, "Digite um valor a ser armazenado", "Vetor 2", 3));
		}
		for (int n = 0; n < 10; n++) {
